		...
		<!-- START LOCK SCREEN ITEM -->
			<div class="lockscreen-item">
				...
				<div class="lockscreen-image">
					<img src="<?php echo base_url() ?>assets/dist/img/<?php echo $links['linksTipe'] ?>.png" alt="User Image">
				</div>
				<!-- /.lockscreen-image -->
				...
				<div class="lockscreen-credentials">
					...
					<div class="input-group">
						...
						<a href="<?php echo $links['links'] ?>" class="btn btn-block btn-lg" target="_blank"><?php echo $links['linksTipe'] ?> <?php echo $links['linksNama'] ?></a>
					</div>
